...
public class Chest extends AppCompatActivity implements WorkoutDialogBoxListener,CheckBoxCheckedListener {
    TextView chestWorkout, chestW;
    EditText sets, reps;
    ArrayList<String> chestList;
    ListView chestListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chestWorkout = (TextView) findViewById(R.id.chest_workout_name);
        ...
        chestList.add("Incline Bench Press");
        chestList.add("Decline Bench Press");
        chestList.add("Cable Crossover");
        chestList.add("Machine Chest Press");
        chestList.add("Push ups");

        WorkoutListAdapter adapter = new WorkoutListAdapter(this, R.layout.workout_list_adapter, chestList);
        chestListView = (ListView) findViewById(R.id.TheListView1);
        chestListView.setAdapter(adapter);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Chest.this);
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(Chest.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.SpinnerItems));
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!spinner.getSelectedItem().toString().equalsIgnoreCase("Select day")) {
                                ...
                                for (int i = 0; i < theCheckedList.size(); i++) {
                                    ...
                                    //Toast.makeText(Chest.this, "Hello" + theCheckedList.size(), Toast.LENGTH_LONG).show();
                                ...
                                if (count == theCheckedList.size()){
                                    Toast.makeText(Chest.this, "Successfully added to "+ spinner.getSelectedItem().toString() + "'s workout", Toast.LENGTH_LONG).show();
                                }
                                else{
                                    Toast.makeText(Chest.this, "Something went wrong", Toast.LENGTH_LONG).show();
                                }
                            }

...
public class UpperBody extends AppCompatActivity implements WorkoutDialogBoxListener, CheckBoxCheckedListener {
    TextView ubodyWorkout, chestW;
    EditText sets, reps;
    ArrayList<String> upperBodylist;
    ListView upperBodyListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ubodyWorkout = (TextView) findViewById(R.id.chest_workout_name);
        ...
        upperBodylist = new ArrayList<>();
        upperBodylist.add("Lat Pull Down");
        upperBodylist.add("Bicep Curls");
        upperBodylist.add("One Arm Row");
        upperBodylist.add("Bent Over Row");
        upperBodylist.add("Pull Ups");
        upperBodylist.add("Dead Lift");
        upperBodylist.add("Tricep Pushdown");

        WorkoutListAdapter adapter = new WorkoutListAdapter(this, R.layout.workout_list_adapter, upperBodylist);
        upperBodyListView = (ListView) findViewById(R.id.TheListView1);
        upperBodyListView.setAdapter(adapter);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(UpperBody.this);
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(UpperBody.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.SpinnerItems));
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!spinner.getSelectedItem().toString().equalsIgnoreCase("Select day")) {
                            ...
                            for (int i = 0; i < theCheckedList.size(); i++) {
                                ...
                                //Toast.makeText(UpperBody.this, "Hello" + theCheckedList.size(), Toast.LENGTH_LONG).show();
                            ...
                            if (count == theCheckedList.size()){
                                Toast.makeText(UpperBody.this, "Successfully added to "+ spinner.getSelectedItem().toString() + "'s workout", Toast.LENGTH_LONG).show();
                            }
                            else{
                                Toast.makeText(UpperBody.this, "Something went wrong", Toast.LENGTH_LONG).show();
                            }
                        }

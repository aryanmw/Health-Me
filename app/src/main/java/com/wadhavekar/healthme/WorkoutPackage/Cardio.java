...
public class Cardio extends AppCompatActivity implements WorkoutDialogBoxListener, CheckBoxCheckedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        absList.add("Running");
        absList.add("Swimming");
        absList.add("Cycling");


        WorkoutListAdapter adapter = new WorkoutListAdapter(this, R.layout.cardio_list_adapter, absList);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(Cardio.this, android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.SpinnerItems));
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!spinner.getSelectedItem().toString().equalsIgnoreCase("Select day")) {
                            ...
                            for (int i = 0; i < theCheckedList.size(); i++) {
                                ...
                                Toast.makeText(Cardio.this, "Hello" + theCheckedList.size(), Toast.LENGTH_LONG).show();
                            ...
                            if (count == theCheckedList.size()){
                                Toast.makeText(Cardio.this, "Successfully added to "+ spinner.getSelectedItem().toString() + "'s workout", Toast.LENGTH_LONG).show();
                            }
                            else{
                                Toast.makeText(Cardio.this, "Something went wrong", Toast.LENGTH_LONG).show();
                            }
                        }
    ...
    public void getCheckBoxCheckedListener(int position) {
        ...
        if (c.isChecked() == true) {
            if (e_r.getText().toString().equals("") && e_s.getText().toString().equals("")) {
                c.setChecked(false);
                Toast.makeText(this, "Please enter either minutes or distance", Toast.LENGTH_LONG).show();
